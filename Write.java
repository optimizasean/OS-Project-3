...
public class Write {
	...
	public static void copyFile(int srcID, int dstID) throws IOException {
		File source = new File("./Data/PC" + srcID + "/target.txt");
		File destination = new File("./Data/PC" + dstID + "/target.txt");
	...
	public static void writeFile(int ID, String message) throws IOException {
		...
		RandomAccessFile raf = new RandomAccessFile("./Data/PC" + ID + "/target.txt", "rw");
